...
- LCD_functions.c/LCD_clear(): gTextBuffer[TEXTBUFFERSIZE-1] to 0-char (Michael Loeffler)
  (overwrites change from 17. May 2007)
- main.h: Version to 0.7.6

14. August 2009

Tests and modifications done by Markus Strobel.
Tested with avr-gcc 4.4.0, avr-libc 1.6.7 (Eclipse 3.4.1 Ganymede) 

- lcd_functions.c - renamed to LCD_functions.c:
  for compatibility with case-sensitivce systems
- Makefile - 2 '\r'(^M) removed (all line-endings \n)
- Makefile - ELFSIZE, parameter changed
- main.h - version to 0.7.5
